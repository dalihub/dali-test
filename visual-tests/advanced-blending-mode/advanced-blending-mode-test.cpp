...
public:
  ...
  void OnInit(Application application)
  {
    ...
    {
      control_1.SetProperty(Dali::DevelActor::Property::BLEND_EQUATION, Dali::BlendEquation::LUMINOSITY);
    }
    ...
    if(Dali::Capabilities::IsBlendEquationSupported(Dali::BlendEquation::SCREEN))
    {
      control_2.SetProperty(Dali::DevelActor::Property::BLEND_EQUATION, Dali::BlendEquation::LUMINOSITY);
    }
    ...
    if(Dali::Capabilities::IsBlendEquationSupported(Dali::BlendEquation::SCREEN))
    {
      control_3.SetProperty(Dali::DevelActor::Property::BLEND_EQUATION, Dali::BlendEquation::LUMINOSITY);
    }
